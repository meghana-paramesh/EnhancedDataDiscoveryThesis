...
class NpyDataset(Dataset):
    def __init__(self, folder_irr, folder_urban, folder_snow, train, inference, transform1=None, transform2=None):
        self.train = train
    ...
    def _load_all_files(self):
        self.complete_files.extend(glob.glob(os.path.join(self.folder_irr, '*.npy'))[ :40000])
        self.complete_files.extend(glob.glob(os.path.join(self.folder_urban, '*.npy'))[ :40000])
        self.complete_files.extend(glob.glob(os.path.join(self.folder_snow, '*.npy'))[ :40000])
