...
# dataset_maxar = NpyDataset(base_dir+"maxar_irrigation_tiles", base_dir+"maxar_urban_tiles", base_dir+"maxar_snow_cap_mountain_tiles", True, False, transform)
# triplet_dataloader = DataLoader(dataset_maxar, batch_size=32, shuffle=True)
...
#     torch.save(checkpoint, 'maxar_triplet.pth')
#     print(f"Epoch [{epoch}/{num_epochs}] Maxar Training Loss: {cur_loss}")
#     plot_training_loss(training_loss, "maxar_triplet", 0)
