...
def train_transformer():
    ...
    dataset = NpyDataset(base_dir+"maxar_irrigation_tiles", base_dir+"planet_irrigation_tiles", base_dir+"maxar_urban_tiles", base_dir+"planet_urban_tiles", base_dir+"maxar_snow_cap_mountain_tiles",  base_dir+"planet_snow_cap_mountains_tiles", True, False, 0, 15000, transform1, transform2)
    ...
    maxar_transformer = Transformer(input_size=embedding_size)
    ...
    for epoch in range(num_epochs):
        ...
        for inputs in train_loader:
            ...
            torch.save(checkpoint_maxar_transformer, 'important/maxar_transformer.pth')
            torch.save(checkpoint_maxar_transformer, 'important/planet_transformer.pth')
            total_train_loss += loss
        transformer_train_loss.append(total_train_loss.item()/len(dataset))
    plot_training_loss(transformer_train_loss, "transformer_loss_norm", 7)
