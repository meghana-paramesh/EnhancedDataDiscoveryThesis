...
def train_transformer_min():
    ...
    base_dir = "/home/CS/mp0157/dataset/corresponding_tiles/"
    dataset = NpyDataset(base_dir+"maxar_irrigation_tiles", base_dir+"planet_irrigation_tiles", base_dir+"maxar_urban_tiles", base_dir+"planet_urban_tiles", base_dir+"maxar_snow_cap_tiles",  base_dir+"planet_snow_cap_tiles", True, False, 0, 15000, transform1, transform2)
    ...
    maxar_transformer = GeospatialTransformer(input_dim=embedding_size, output_dim=256)
    planet_transformer = GeospatialTransformer(input_dim=embedding_size, output_dim=256)
    ...
    for epoch in range(num_epochs):
        ...
        for inputs in train_loader:
            ...
            torch.save(checkpoint_maxar_transformer, 'important/maxar_transformer_min.pth')
            torch.save(checkpoint_maxar_transformer, 'important/planet_transformer_min.pth')
