...
def plot_training_validation_loss(training_loss, validation_loss, png_name, ind):
    plt.figure(ind)
...
def plot_training_loss(training_loss, png_name, ind):
    plt.figure(ind)
    epoch = [i for i in range(len(training_loss))]
...
# valid_loss=[1,3,5,7,9]
# valid_loss1=[2,4,6,8,10]
# plot_training_validation_loss(train_loss, valid_loss, "test", 1)
# plot_training_validation_loss(train_loss, valid_loss1, "test1", 2)
