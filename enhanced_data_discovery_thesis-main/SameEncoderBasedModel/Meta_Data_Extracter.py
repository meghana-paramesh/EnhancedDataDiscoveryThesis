...
def get_maxar_meta_data(filename, image_file):
    ...
    return MetaData(time, ullon, ullat, urlon, urlat, lrlon, lrlat, lllon, lllat, image_file)
...
def get_planet_meta_data(filename, image_file):
    ...
    return MetaData(acquisition_date, ullon, ullat, urlon, urlat, lrlon, lrlat, lllon, lllat, image_file)
